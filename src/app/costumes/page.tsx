...
function CostumesPageContent() {
  useEffect(() => {
    ...
    localStorage.setItem('previousPath', '/costumes');
  }, []);
  ...
  const [, setBannerCostumes] = useState<ExtendedCostumeWithCharacter[]>([]);
  const [, setBanners] = useState<unknown[]>([]);
